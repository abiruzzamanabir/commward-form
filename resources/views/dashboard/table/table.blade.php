                        ...
                        @else
                            <form action="{{ route('dashboard.payment') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-info btn-sm">
                                    Send Mail For Payment <span
                                        class="badge bg-success">{{ $item->paymentLinkSend }}</span>
                                </button>
                            </form>
                        @endif
                    </td>
                            ...
                            @if ($item->payment == 2)
                                <form action="{{ route('dashboard.payment.confirm') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-info btn-sm">
                                        ...
                                        <span class="badge bg-success">{{ $item->confirmLinkSend }}</span>
                                    </button>
                                </form>
                            @else
                                <span class="text-muted">N/A</span>
                            ...
                            @if ($item->trash)
                                <div class="btn-group-sm">
                                    ...
                                    <form action="{{ route('dashboard.destroy', $item->id) }}" method="POST"
                                        class="d-inline"
                                        onsubmit="return confirm('Are you sure to permanently delete?');">
                                        @csrf
                                        @method('DELETE')
